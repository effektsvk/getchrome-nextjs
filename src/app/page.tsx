  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-black text-white p-4">
      <div className="w-full max-w-2xl mx-auto">
          ...
          <div className="space-y-3">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-500">Copy and paste the command above into PowerShell</p>
              </div>
            </div>
            <div className="flex items-start">
              <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-950 text-blue-500 mr-3 mt-0.5">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-500">We automatically serve a PowerShell script</p>
              </div>
            </div>
            <div className="flex items-start">
              <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-950 text-blue-500 mr-3 mt-0.5">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-500">The latest version of Chrome is installed silently</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500">No browser needed to download Chrome</p>
                </div>
              </div>
              <div className="flex items-start">
                <ArrowRight className="h-5 w-5 text-blue-500 mr-2 mt-0.5" />
                <div>
                  ...
                  <p className="text-sm text-zinc-500">Always installs the current release</p>
                </div>
              </div>
              <div className="flex items-start">
                <ArrowRight className="h-5 w-5 text-blue-500 mr-2 mt-0.5" />
                <div>
                  ...
                  <p className="text-sm text-zinc-500">No clicks or prompts needed</p>
                </div>
              </div>
              <div className="flex items-start">
                <ArrowRight className="h-5 w-5 text-blue-500 mr-2 mt-0.5" />
                <div>
                  ...
                  <p className="text-sm text-zinc-500">Perfect for new computer setup</p>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        {/* Footer */}
        <footer className="text-center text-sm text-zinc-500 space-y-1">
